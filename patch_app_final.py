...
# Finished
# Need to add durationMs to attempt before saving state
p4 = """                        console.log(`[SEGMENT_ENGINE] Finished segment ${attempt.segmentId}!`, {
                          durationMs,
...
r4 = """                        console.log(`[SEGMENT_ENGINE] Finished segment ${attempt.segmentId}!`, {
                          durationMs,
                          distanceCovered: attempt.distanceCovered
                        });
