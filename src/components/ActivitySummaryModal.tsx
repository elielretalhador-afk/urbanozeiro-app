    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80  animate-in fade-in duration-200">
      ...
      >
        ...
        {(xpEarnedVal > 0 || conqueredCount > 0 || visitedCount > 0) && (
          <div className="flex items-center justify-between gap-2 p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 mb-3 font-mono-stat text-xs">
            {xpEarnedVal > 0 && (
        ...
        {/* Info Notice */}
        <div className="p-2.5 rounded-xl bg-[#00ff66]/10 border border-[#00ff66]/30 text-slate-300 text-[11px] font-medium text-center mb-4">
