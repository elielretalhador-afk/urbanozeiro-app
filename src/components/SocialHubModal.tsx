...
export const SocialHubModal: React.FC<SocialHubModalProps> = ({
  ...
  const renderStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'ONLINE':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-400 text-[9px] font-black uppercase font-mono-stat shrink-0">
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg rounded-3xl bg-[#090e15] border-2 border-emerald-500/50 shadow-[0_0_50px_rgba(0,255,102,0.2)] overflow-hidden flex flex-col h-[88vh] text-left animate-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="p-4 bg-gradient-to-b from-[#0e1724] via-[#0b121c] to-[#090e15] border-b border-white/10 relative">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="p-2.5 rounded-2xl bg-emerald-400/15 border border-emerald-400/40 text-emerald-400 shadow-[0_0_15px_rgba(0,255,102,0.25)]">
              ...
              <div>
                <h2 className="text-base font-black text-white uppercase font-display tracking-tight flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-emerald-400/20 text-emerald-400 text-[9px] font-black font-mono-stat border border-emerald-400/30">
                    ESQUELETO URBANO
                  </span>
                </h2>
          ...
          <div className="grid grid-cols-5 gap-1 mt-3.5 p-1 rounded-2xl bg-black/40 border border-white/10">
            ...
            >
              ...
              {totalPendingRequests > 0 && activeTab !== 'solicitacoes' && (
                <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-emerald-400 text-black text-[9px] font-black flex items-center justify-center border border-black shadow-[0_0_8px_#00ff66]">
        ...
        {showPrivacyConfig && (
          <div className="p-4 bg-[#0c1420] border-b border-emerald-500/30 space-y-3 animate-in slide-in-from-top-2 duration-200">
            <div className="flex items-center justify-between">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between p-2 rounded-xl bg-black/30 border border-white/5">
                ...
                <button
                  ...
                  className={`w-10 h-5 rounded-full transition-colors relative p-0.5 cursor-pointer ${
                    privacySettings.appearInNearby ? 'bg-emerald-500' : 'bg-slate-700'
                  }`}
                >
                  <div
              ...
              <div className="flex items-center justify-between p-2 rounded-xl bg-black/30 border border-white/5">
                ...
                <button
                  ...
                  className={`w-10 h-5 rounded-full transition-colors relative p-0.5 cursor-pointer ${
                    privacySettings.allowChallengeInvites ? 'bg-emerald-500' : 'bg-slate-700'
                  }`}
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between p-2 rounded-xl bg-black/30 border border-white/5">
                ...
                <button
                  ...
                  className={`w-10 h-5 rounded-full transition-colors relative p-0.5 cursor-pointer ${
                    privacySettings.allowFriendRequests ? 'bg-emerald-500' : 'bg-slate-700'
                  }`}
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-white transition-transform ${
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          ...
          {activeTab === 'amigos' && (
            <div className="space-y-2.5">
              <div className="flex items-center justify-between text-[11px] font-bold text-slate-400 font-mono-stat uppercase px-1">
                ...
                <span className="text-emerald-400">Disponíveis para Desafios</span>
              </div>
              ...
              {friends.length === 0 ? (
                <div className="p-8 text-center rounded-2xl bg-[#0d141e] border border-white/10 space-y-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveTab('sugestoes')}
                    className="mt-2 px-3 py-1.5 rounded-xl bg-emerald-400 text-black text-xs font-black uppercase font-mono-stat"
                  >
                    Ver Sugestões →
                  </button>
                </div>
                ...
                friends.map((player) => (
                  <div
                    key={player.id}
                    className="p-3 rounded-2xl bg-[#0d141e] border border-white/10 hover:border-emerald-500/40 transition-all flex items-center justify-between gap-3 group"
                  >
                    ...
                    >
                      <div className="relative shrink-0">
                        <img
                          src={player.avatar}
                          alt={player.nickname}
                          className="w-12 h-12 rounded-xl object-cover border border-emerald-400/60"
                        />
                        <span className="absolute -bottom-1 -right-1 px-1 py-0.2 rounded bg-black text-emerald-400 border border-emerald-400/40 text-[8px] font-black font-mono-stat">
                          LVL {player.level}
                        </span>
                      </div>
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-black text-white uppercase font-display truncate group-hover:text-emerald-300 transition-colors">
                            {player.nickname}
                          </h4>
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        ...
                        className="py-1.5 px-2.5 rounded-xl bg-emerald-400 hover:bg-emerald-300 text-black text-[10px] font-black uppercase font-mono-stat tracking-wider transition-all shadow-[0_0_10px_rgba(0,255,102,0.3)] active:scale-95 flex items-center gap-1 cursor-pointer"
          ...
          {activeTab === 'proximos' && (
            <div className="space-y-2.5">
              <div className="p-3 rounded-2xl bg-gradient-to-r from-emerald-950/30 via-[#0d141e] to-cyan-950/30 border border-emerald-500/30 flex items-start gap-2.5">
          ...
          {activeTab === 'sugestoes' && (
            <div className="space-y-2.5">
              ...
              {suggestions.map((player) => (
                <div
                  key={player.id}
                  className="p-3 rounded-2xl bg-[#0d141e] border border-white/10 hover:border-emerald-500/40 transition-all flex items-center justify-between gap-3"
                >
                  <div
                    onClick={() => onSelectPlayer(player)}
                    className="flex items-center gap-3 min-w-0 flex-1 cursor-pointer"
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button
                      ...
                      className="py-1.5 px-3 rounded-xl bg-emerald-400/20 border border-emerald-400/40 text-emerald-300 hover:bg-emerald-400 hover:text-black text-[10px] font-black uppercase font-mono-stat tracking-wider transition-all flex items-center gap-1 cursor-pointer"
                    >
              ...
              <div>
                <div className="text-[11px] font-bold text-slate-400 font-mono-stat uppercase mb-2 px-1 flex items-center justify-between">
                  ...
                  {receivedRequests.length > 0 && (
                    <span className="text-emerald-400">Aguardando sua resposta</span>
                  )}
                </div>
                ...
                {receivedRequests.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {receivedRequests.map((player) => (
                      <div
                        key={player.id}
                        className="p-3 rounded-2xl bg-[#0d141e] border border-emerald-500/40 flex items-center justify-between gap-3"
                      >
                        <div
                          onClick={() => onSelectPlayer(player)}
                          className="flex items-center gap-3 min-w-0 flex-1 cursor-pointer"
                        >
                          <img
                            src={player.avatar}
                            alt={player.nickname}
                            className="w-11 h-11 rounded-xl object-cover border border-emerald-400/50 shrink-0"
                          />
                          <div className="min-w-0">
                            <h4 className="text-sm font-black text-white uppercase font-display truncate">
                              {player.nickname}
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          <button
                            ...
                            className="py-1.5 px-3 rounded-xl bg-emerald-400 hover:bg-emerald-300 text-black text-[10px] font-black uppercase font-mono-stat tracking-wider transition-all cursor-pointer shadow-[0_0_10px_rgba(0,255,102,0.3)]"
                          >
                            ACEITAR
                          </button>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-[#0d141e] border border-white/15 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-400 transition-all"
                  autoFocus
                />
                {searchQuery && (
                  <button
                ...
                <div className="space-y-2">
                  ...
                  {searchResults.map((player) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        {player.isFriend ? (
                          <span className="px-2 py-1 rounded-lg bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-[10px] font-bold font-mono-stat">
                            AMIGOS ✓
                          </span>
                          ...
                          <button
                            type="button"
                            onClick={() => onSendFriendRequest(player.id)}
                            className="py-1.5 px-3 rounded-xl bg-emerald-400/20 border border-emerald-400/40 text-emerald-300 hover:bg-emerald-400 hover:text-black text-[10px] font-black uppercase font-mono-stat transition-all"
                          >
                            ADICIONAR
                          </button>
                        )}
            ...
            <div className="text-[11px] text-slate-300 truncate">
              {publicActivities[0] ? (
                <>
                  ...
                  <span className="text-emerald-400">{publicActivities[0].targetName}</span>{' '}
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {onOpenActivityFeed && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/40 text-emerald-300 font-bold text-xs uppercase font-mono-stat flex items-center gap-1 cursor-pointer"
              >
                <span>VER FEED</span>
